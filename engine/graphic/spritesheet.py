...
def load_sheet(location, rect, image_count, pixel_jump=0, start_at=0):
    rectangles = [((rect[0]+rect[2])*i+(pixel_jump*i), rect[1], rect[2], rect[3]) for i in range(start_at,start_at+image_count)]
